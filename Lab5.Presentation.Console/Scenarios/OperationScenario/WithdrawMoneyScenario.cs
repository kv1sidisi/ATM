...
public class WithdrawMoneyScenario : IScenario
{
    ...
    public WithdrawMoneyScenario(IOperationService operationService)
    {
    ...
    public void Run()
    {
        double amount = AnsiConsole.Ask<double>("Enter amount of money to withdraw");
        ...
        TransactionResult resultType = _operationService.Withdraw(amount);
